      ...
      <section class="new-bg">
        ...
        <section class="section topNews wow fadeInDown" data-wow-delay=".2s">
          ...
          <div class="container">
            <div class="col">
              <a href="#">
                <h3>標題 Lorem ipsum dolor, sit, amet consectetur adipisicing elit. Tempore esse ut dolores, facere quae omnis sunt assumenda quas repellendus saepe modi earum iure, quidem velit eos optio obcaecati debitis praesentium.</h3>
                <div class="caption">
                  <img src="images/default.jpg" alt="" class="cover">
                  <span>
                    <time datetime="2018.01.06-09">2020 / 3.17</time>
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing, elit. Sapiente, ut blanditiis accusamus, ratione alias quasi quibusdam distinctio cum? Nam consequuntur dolorem vero in quidem, rem quis, neque earum quasi! Iusto.</p>
                    <p class="more"><span>更多詳細內容</span></p> 
                  </span>
                </div>
              </a>
            </div>
                ...
                <section>
                  <a href="https://www.google.com/?hl=zh_tw">
                    ...
                    <div class="caption">
                      ...
                      <p>中央流行疫情指揮中心今(17)日表示，中國大陸以外的亞洲國家近期疫情擴大，確診病例數已逾1萬例，病例數持續增加中，多國已宣布進入緊急狀態並採取嚴格之邊境管制及檢疫措施；另美國近期疫情亦持續上升。....</p>
                    </div>
                  </a>
                </section>
                <section>
