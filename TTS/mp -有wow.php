  ...
  <div class="wrapper MP">
    ...
    <header class="header fixed">
      <div class="container">
        ...
        <nav class="navigation">
          <ul>
            <li><a class='iframe' href="include/inc_signUp.php">LOG IN</a><a href="#">SIGN UP</a></li>
            <li><a href="#">English</a>
              <ul>
    ...
    <div id="center" class="main">
      <div class="container">
          ...
          <div class="container">
            <div class="col">
              ...
              <div class="startText zh">
                <div class="wow fadeInDown slogan" data-wow-delay="0.3s">發掘更多展覽<span>立刻註冊</span></div>
              </div>
              <!-- function button -->
              <div class="wow fadeInUp startBtn" data-wow-delay="0.5s">
                <button type="button" class="btn-switch">About TTS</button>
                <button type="button" class="btn-switch">Discover Now</button>
              </div>
              <div class="singleSlider">
                ...
                <a href="javascript:void(0)">
                  <div class="img-container">
                    <div class="BuildingName">(4)
                    Taipei Nangang Exhibition Center</div>
                    <img src="images/banner/KV-Banner4.jpg" class="cover" alt="banner">
                  </div>
                </a>
                <a href="javascript:void(0)">
                  <div class="img-container">
                    <div class="BuildingName">(5)
                    )MICE 高雄會展網</div>
        ...
        <!-- 裝飾背景圖 -->
        <section class="section col-4-8 MP-gridCard">

          <div class="container">
            <div class="col">
              <h2 class="wow fadeInDown" data-wow-delay="0s">Upcoming Events</h2>
              <!-- particles-->
           ...
           <div class="col">
             ...
             <!-- 小尺寸singleSlider -->
             <div class="m_singleSlider wow fadeInDown" data-wow-delay="0.2s">
              <div>
                <div class="img-container">
               ...
               <div class="caption">
                <!-- 注意：h3和P一併：截字二行字 -->
                <h3>2018 Smart Asia 2018 Smart Asia Taiwpo to get underway in Taichung</h3>
            ...
            <div>
              ...
              <div class="caption">
                ...
                <time datetime="2018.01.06-09">January 05-09, 2018</time><a href="#"><span class="favorite active"><i class="icon-star-1"></i>Follow This Event</span></a>
          ...
          <!-- 大尺寸slider -->
          <div class="singleSlider wow fadeInDown" data-wow-delay="0s">
            <div>
                  ...
                  <a href="http://google.com" target="_blank">
                    <div class="caption">
                      <div class="cardText">
                       ...
                       <h3>TWTC NEW YEAR SHOPPING FAIR</h3>
                       <p>Wine & Spirits & 
                       </p>
                     </div>
              ...
              <div class="img-container">
                <a href="javascript:void(0);" target="_blank">
                  <div class="caption">
                    <div class="cardText">
                     <time datetime="2019.05.09">JAN 05-09, 2019</time>
                     <h3>TWTC NEW YEAR SHOPPING FAIRFood， Frozen Prepared</h3>
                     <p>Wine & Spirits， Coffee
                     </p>
                   </div>
                   <span class="favorite active"><i class="icon-star-1"></i>Follow This Event</span>
                   <span class="readmore">Read More</span>
              ...
              <a href="http://google.com" target="_blank">
                <div class="caption">
                  <div class="cardText">
                   <time datetime="2019.05.09">JAN 05-09, 2019</time>
                   <h3>TWTC NEW YEAR SHOPPING FAIR</h3>
                   <p>Confections & Biscuits， Health Food
                   </p>
                 </div>
                 <span class="favorite active"><i class="icon-star-1"></i>Follow This Event</span>
                 <span class="readmore">Read More</span>
          ...
          <div class="img-container">
            <a href="http://google.com" target="_blank">
              <div class="caption">
                <div class="cardText">
                 <time datetime="2019.05.09">JAN 05-09, 2019</time>
                 <h3>TWTC NEW YEAR TWTC NEW YEAR SHOPPING FAIR</h3>
                 <p>Products，Seafood， Preserved Fruits & Vegetables， Baked Food， Groceries， Gifts
                 </p>
               </div>
               <span class="favorite active"><i class="icon-star-1"></i>Follow This Event</span>
               <span class="readmore">Read More</span>
      ...
      <div class="img-container">
        <a href="http://google.com" target="_blank">
          <div class="caption">
            <div class="cardText">
             <time datetime="2019.05.09">JAN 05-09, 2019</time>
             <h3>TWTC NEW YEAR SHOPPING FAIRF
             </p>
           </div>
           <span class="favorite active"><i class="icon-star-1"></i>Follow This Event</span>
           <span class="readmore">Read More</span>
      ...
      <a href="http://google.com" target="_blank">
        <div class="caption">
          <div class="cardText">
           <time datetime="2019.05.09">JAN 05-09, 2019</time>
           <h3>TWTC NEW YEAR SHOPPING FAIR</h3>
           <p>Wine & SpiritsPreserved Fruits & Vegetables， Baked Food， Groceries， Gifts...
           </p>
         </div>
         <span class="favorite active"><i class="icon-star-1"></i>Follow This Event</span>
         <span class="readmore">Read More</span>
      ...
      <a href="http://google.com" target="_blank">
        <div class="caption">
          <div class="cardText">
           <time datetime="2019.05.09">JAN 05-09, 2019</time>
           <h3>TWTC NEW YEAR SHOPPING FAIR</h3>
           <p>Wine & Spiriea， Juice & Soft Drinks， Confections & Biscuits， Health Food & Leoceries， Gifts...
           </p>
         </div>
         <span class="favorite active"><i class="icon-star-1"></i>Follow This Event</span>
         <span class="readmore">Read More</span>
      ...
      <a href="http://google.com" target="_blank">
        <div class="caption">
          <div class="cardText">
           <time datetime="2019.05.09">JAN 05-09, 2019</time>
           <h3>TWTC NEW YEAR SHOPPING FAIR</h3>
           <p>Wine & Spirits， Coffee & Tea， Juice & Soft Drinks， Confections & Biscuits， Health Food & Leoceries， Gifts...
           </p>
         </div>
         <span class="favorite active"><i class="icon-star-1"></i>Follow This Event</span>
         <span class="readmore">Read More</span>
...
<!-- What's on -->
<section class="section col-12 whatsOn">
  <!-- 注意：只有這個標題要加連結 -->
  <h2 class="wow fadeInDown" data-wow-delay="0s"><a href="http://google.com" target="_blank">What's on</a></h2>
  <div class="container">
    <div class="col">
      <div class="singleSlider wow fadeInDown" data-wow-delay="0.2s">
        <div>
          <div class="img-container">
            <a href="javascript:void(0);"" title="">
...
<!--PHOTO & VIDEO GALLERY -->
<section class="section col-12 photoVideo">
  <h2 class="wow fadeInDown" data-wow-delay="0s">PHOTO & VIDEO GALLERY</h2>
  <div class="container">
    <div class="col">

      <!-- 小尺寸singleSlider -->
      <div class="m_singleSlider wow fadeInDown" data-wow-delay="0.1s">
        <div>
          <div class="img-container">
       ...
       <div>
         <div class="img-container">
          <iframe width="100%" height="100%" src="https://www.youtube.com/embed/xI0xKZtoEEo" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        <div class="caption">
         <h3>TWTC NEW YEAR SHOPPING FAIRTWTC YEAR SHOPPING FAIRTWTC NEW YEAR SHOPPING FAIR</h3>
         <time datetime="2019.05.09">JAN 05-09, 2019</time>
...
<div class="masonry-container">
  <div class="panel wow fadeInDown" data-wow-delay="0.1s">
 ...
 <div class="panel wow fadeInDown" data-wow-delay="0.2s">
  <div class="panel-wrapper">
    <div class="img-container">
...
<div class="panel wow fadeInDown" data-wow-delay="0.3s">
  <div class="panel-wrapper">
    <div class="img-container">
...
<div class="panel wow fadeInDown" data-wow-delay="0.4s">
  <div class="panel-wrapper">
    <div class="img-container">
...
<div class="panel wow fadeInDown" data-wow-delay="0.5s">
  <div class="panel-wrapper">
    <div class="img-container">
      <a href="http://player.vimeo.com/video/2285902" target="_blank" class="youtube"  title="Me and my grandfather on the Ohoopee.">
        <div class="caption">
...
<div class="panel wow fadeInDown" data-wow-delay="0.6s">
  <div class="panel-wrapper">
    <div class="img-container">
      <a href="http://player.vimeo.com/video/2285902" target="_blank" class="youtube"  title="Me and my grandfather on the Ohoopee.">
        <div class="caption">
...
<div class="panel wow fadeInDown" data-wow-delay="0.7s">
  <div class="panel-wrapper">
    <div class="img-container">
...
<div class="panel wow fadeInDown" data-wow-delay="0.8s">
  <div class="panel-wrapper">
    <div class="img-container">
...
<div class="panel wow fadeInDown" data-wow-delay="0.9s">
  <div class="panel-wrapper">
    <div class="img-container">
...
<section class="section col-4 partners">
 ...
 <div class="container">
  ...
  <div class="m_adSlider">
    <div>
     <div class="img-container"><a href="#"><img src="images/mem-qrcode.jpg" alt="" class="contain"></a>
     </div>
   </div>
   <div>
     <div class="img-container"><a href="#"><img src="images/partner2.jpg" alt="" class="contain"></a>
     </div>
   </div>
   <div>
     <div class="img-container"><a href="#"><img src="images/sample3-banner.png" alt="" class="contain"></a>
     </div>
   </div>
   <div>
     <div class="img-container"><a href="#"><img src="images/partner1.gif" alt="" class="contain"></a>
     </div>
   </div>
   <div>
     <div class="img-container"><a href="#"><img src="images/logo-en.png" alt="" class="contain"></a>
     </div>
   </div>
 </div>
 ...
 <div class="col">
  ...
  <div class="col">
    ...
    <div class="col">
      <div class="img-container"><a href="#"><img src="images/partner2.jpg" class="contain" alt=""></a>
      </div></div>
      <div class="col">
        <div class="img-container"><a href="#"><img src="images/partner3.gif" class="contain" alt=""></a>
        </div></div>
        <div class="col">
          <div class="img-container"><a href="#"><img src="images/partner2.jpg" alt="" class="contain"></a>
          </div></div>
          <div class="col">
            <div class="img-container"><a href="#"><img src="images/partner3.gif" alt="" class="contain"></a>
            </div></div>
            <div class="col">
              <div class="img-container"><a href="#"><img src="images/partner1.gif" class="contain" alt=""></a>
              </div></div>
              <div class="col">
                <div class="img-container"><a href="#"><img src="images/partner3.gif" class="contain" alt=""></a>
                </div></div>
