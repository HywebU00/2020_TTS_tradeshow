            ...
            <li>
              ...
              <li class="active">
                ...
                <ul>
                  ...
                  <li class="active"><a href="#">Exhibitor</a></li>
            ...
            <form action="" class="form_grid form_vertical">
             <div class="Pre-entry">
              <div class="form_grp has-danger">
                <label for="mustSameAsId" class="form_title">Original Password<span class="necessary">*</span></label>
              ...
              <div class="form_grp">
                <label for="mustSameAsId" class="form_title">New Password<span class="necessary">*</span></label>
                <div class="form_content">
                  <input type="text" placeholder="">
                </div>
              </div>
              <div class="form_grp">
                <label for="mustSameAsId" class="form_title">Confirm New Password<span class="necessary">*</span></label>
                <div class="form_content">
                  <input type="text" placeholder="">
                </div>
              </div>
