        ...
        <div class="modalBox modalSignup">
            ...
            <form action="" class="form_grid form_vertical">
                ...
                <div class="form_grp has-danger">
                    ...
                    <div class="form_content form-control-danger">
                        <input type="password" id="password" name="password" placeholder="密碼" style="box-shadow: 0 0px 0px 1px #f00 inset !important;" aria-invalid="true" aria-describedby="password-error"><div id="password-error" class="form-control-feedback">必須填寫</div>
                    </div>
                </div>
